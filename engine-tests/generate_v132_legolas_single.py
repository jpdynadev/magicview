...
OUT = DECKS / 'Kinnan_ARCH_F10_LEGOLAS_SINGLE.dck'
CUTS = ['Endurance']
ADDS = ["Legolas's Quick Reflexes"]
...
header[1] = 'Name=Kinnan ARCH F10 Legolas Quick Reflexes Single'
OUT.write_text('\n'.join(header + [f'1 {c}' for c in cards]) + '\n')
print('F10_LEGOLAS_SINGLE cuts=', CUTS, 'adds=', ADDS)
