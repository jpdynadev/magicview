...
OUT = DECKS / 'Kinnan_ARCH_F10_HIDDENSTRINGS_REFR.dck'
CUTS = ['Energy Refractor']
ADDS = ['Hidden Strings']
...
header[1] = 'Name=Kinnan ARCH F10 Hidden Strings over Energy Refractor'
OUT.write_text('\n'.join(header + [f'1 {c}' for c in cards]) + '\n')
print('F10_HIDDENSTRINGS_REFR cuts=', CUTS, 'adds=', ADDS)
