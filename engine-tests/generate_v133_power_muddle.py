...
OUT = DECKS / 'Kinnan_ARCH_F10_POWER_MUDDLE.dck'
CUTS = ['Energy Refractor', 'Treasure Mage']
ADDS = ['Power Artifact', 'Muddle the Mixture']
...
header[1] = 'Name=Kinnan ARCH F10 Power Artifact Muddle Package'
OUT.write_text('\n'.join(header + [f'1 {c}' for c in cards]) + '\n')
print('F10_POWER_MUDDLE cuts=', CUTS, 'adds=', ADDS)
