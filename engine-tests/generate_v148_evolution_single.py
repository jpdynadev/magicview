...
DST = DECKS / 'Kinnan_ARCH_F10_EVOLUTION_SINGLE.dck'

# Revalidate the strongest surviving v147 exposure signal without the costly
# Hydroelectric Specimen cut or the neutral Cyclonic Rift package partner.
CUTS = ['Misdirection']
ADDS = ['Eldritch Evolution']
