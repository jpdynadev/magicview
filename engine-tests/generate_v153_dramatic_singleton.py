...
OUT = DECKS / "Kinnan_ARCH_F10_DRAMATIC_SINGLETON.dck"
CUTS = ["Energy Refractor"]
ADDS = ["Dramatic Reversal"]
...
header[1] = "Name=Kinnan F10 Dramatic Singleton"
OUT.write_text("\n".join(header + [f"1 {card}" for card in cards]) + "\n")
print("F10_DRAMATIC_SINGLETON", "CUT", CUTS, "ADD", ADDS)
